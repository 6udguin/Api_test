...
public class MovieVo {
	...
	private double userRating; // 검색 결과 영화에 대한 유저들의 평점이다.
	...
	public MovieVo(String title, String link, String image, String subtitle, String pubDate, String director,
			String actor, double userRating) {
		super();
		this.title = title;
		this.link = link;
		this.image = image;
	...
	public String toString() {
		return "SearchVo [title=" + title + ", link=" + link + ", image=" + image + ", subtitle=" + subtitle
